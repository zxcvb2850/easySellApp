			...
			<View style={styles.figure}>
			  <View style={styles.table_wrapper}>
				<View style={[styles.table_item, styles.table_header]}>
				  <Text style={styles.table_td}>表头一</Text>
				  <Text style={styles.table_td}>表头二</Text>
				  <Text style={styles.table_td}>表头三</Text>
				  <Text style={styles.table_td}>表头四</Text>
				</View>
				<View style={[styles.table_item, styles.table_item_last]}>
				  <Text style={styles.table_td}>内容一</Text>
				  <Text style={styles.table_td}>内容二</Text>
				  <Text style={styles.table_td}>内容三</Text>
				  <Text style={styles.table_td}>内容四</Text>
				</View>
				<View style={[styles.table_item, styles.table_item_last]}>
				  <Text style={styles.table_td}>内容一</Text>
				  <Text style={styles.table_td}>内容二</Text>
